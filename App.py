...
TITLES_PATH = r"C:\example-folder\Data\movie_titles.json"
DATA_PATH = r"C:\example-folder\Data\movie_data.json"
...
def run():
    img1 = Image.open(r"C:\example-folder\logo.jpg").resize((250, 250))
